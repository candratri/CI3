...
<div class="container">
  <h3>CATEGORY</h3>
      ...
      <div class="col-xs-12 col-sm-9 col-md-9">
          <div class="row">
            <div class="col-md-4">
              <h3><?php echo $key->name_cat ?></h3>
              <br>
              <p>
                diupload tanggal : <?php echo $key->tgl_cat ?><br>
                <a href="<?php echo site_url()?>view_pengiriman/detail/<?php echo $key->id_cat ?>">Read More ...</a>
              </p>
              <br></br>
              <!-- button delete -->
